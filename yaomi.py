...
#game parameters
items = ['Spellthief\'s Edge', 'Faerie Charm', 'Amplifying Tome', 'Bandleglass Mirror', 
         'Ruby Crystal', 'Kindlegem', 'Moonstone Renewer', 'Faerie Charm', 'Forbidden Idol', 
         'Ruby Crystal', 'Kindlegem', 'Redemption', 'Null-Magic Mantle', 'Negatron Cloak', 
         'Faerie Charm', 'Forbidden Idol', 'Mikael\'s Blessing', 'Watchful Wardstone', 'Amplifying Tome', 
         'Amplifying Tome', 'Faerie Charm', 'Forbidden Idol', 'Staff of Flowing Water']
...
item_gold = [400, 250, 435, 265, 400, 400, 750, 250, 550, 400, 400, 700, 450, 450, 250, 550, 600, 1100, 435, 435, 250,
            550, 630]
